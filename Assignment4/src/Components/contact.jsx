...
export default function Contact() {
    return (
        <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700 text-white h-[140vh] flex flex-col justify-center items-center gap-6 px-4 font-mono">
